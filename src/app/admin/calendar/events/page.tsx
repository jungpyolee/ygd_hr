...
function EventFormSheet({ event, onClose, onSave, onDelete }: EventFormSheetProps) {
  ...
  return (
    <div className="fixed inset-0 z-[200] flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-md bg-white rounded-[28px] px-5 pt-6 pb-6 shadow-2xl animate-in zoom-in-95 fade-in-0 duration-200 max-h-[90vh] overflow-y-auto scrollbar-hide">
